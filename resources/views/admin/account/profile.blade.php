                    ...
                    <ul class="nav nav-tabs nav-material" id="top-tab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ $errors->has('current_password') || $errors->has('new_password') || $errors->has('confirm_password') ? 'active' : '' }}"
                                ...
                                <i data-feather="settings"></i>{{ __('static.user.change_password') }}
                            </a>
                        </li>
                    </ul>
                    <div class="tab-content" id="top-tabContent">
                            ...
                            <div class="card-body pb-0">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-xl-9 col-md-8 phone-detail">
                                        ...
                                        {!! Form::text('phone', Auth::user()->phone ? Auth::user()->phone : old('phone'), ['class' => 'form-control']) !!}
                                    </div>
                                </div>
                                <div class="form-group row">
                                    {!! Form::label(
                        ...
                        <div class="tab-pane fade {{ $errors->has('current_password') || $errors->has('new_password') || $errors->has('confirm_password') ? 'active show' : '' }}"
                            ...
                            <div class="account-setting">
                                {!! Form::open(['route' => 'account.password.update', 'method' => 'PUT', 'class' => 'needs-validation']) !!}
                                <div class="card-body pb-0">
                                    <div class="form-group row">
