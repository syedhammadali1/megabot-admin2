...
@section('title', __('static.user.create_user'))
        ...
        <div class="col-sm-10 col-xxl-8 mx-auto">
            <div class="card tab2-card">
                <div class="card-header">
                    <h5>{{ __('static.user.create_user') }}</h5>
                </div>
                {!! Form::open([
                    'route' => 'user.store',
                    'method' => 'POST',
                ...
                <div class="card-body">
                    ...
                    {{-- <div class="form-group row">
                        {!! Form::label('PHONE', __('static.users.phone') . ' <span>*</span>', ['class' => 'col-xl-3 col-md-4'], false) !!}
                        <div class="col-xl-9 col-md-8">
                            {!! Form::text('phone', old('phone'), ['class' => 'form-control']) !!}
                            @error('phone')
                                <span class="invalid-feedback d-block" role="alert">
                    ...
                    <div class="form-group row">
                        {!! Form::label(
                            'password',
                            __('static.user.password') . ' <span>*</span>',
                    ...
                    <div class="form-group row">
                        {!! Form::label(
                            'confirm_password',
                            __('static.user.confirm_password') . ' <span>*</span>',
                            ['class' => 'col-xl-3 col-md-4'],
                            false,
                        ) !!}
                        <div class="col-xl-9 col-md-8">
